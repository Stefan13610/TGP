...
### Tor roboczy 2026 (ścieżka 9, kosmologia, solitony, O-J3) — **kanoniczne do utrzymania**
...
| Katalog | Zawartość |
|---------|-----------|
| `_archiwum/` | Starsze eksperymenty (ex1–ex54, ex związane z Efimov, K13–K18, GW, FDM, …). Zob. [_archiwum/README.md](_archiwum/README.md). |
