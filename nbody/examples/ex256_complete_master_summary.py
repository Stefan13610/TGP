...
predictions = [
    ...
    ("Σm_ν [meV]", "K=1/2 + Δm² (NO)", 59.6, "<120", "—", "TESTABLE", "ex254"),
    ("m₁ [meV]", "K=1/2 + Δm²", 0.80, "?", "—", "PREDICTION", "ex254"),
    ("m₂ [meV]", "K=1/2 + Δm²", 8.65, "?", "—", "PREDICTION", "ex254"),
    ("m₃ [meV]", "K=1/2 + Δm²", 50.11, "~50±5", "~1%", "TESTABLE", "ex254"),
