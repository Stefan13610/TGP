...
Twierdzenie           & 24 & wysoka & +9 v41: metryka, $\kappa$, ghost, $\pi_1$, Fermi, $\varphi$-FP, $r_{21}$, $n_s$, $r$; +1 v47b: degeneracja $\alpha$ \\
Propozycja            & 27 & \'srednia & +6: antypod., $S_{\rm TGP}$, profile, chiralnosc, U(1), $k{=}4$ wymiar., \l{}a\'ncuch entrop.; +4 v47b: most substrat$\to g_0^e$, O-J1, 0-param., $c$-cyklotom. \\
Hipoteza              & 5  & niska & $m_\tau$; T1+T2; $a_\Gamma\Phi_0{=}1$ (DESI DR2); CV${=}1$ \\
Szkic                 & 2  & --- & SU(2), SU(3) \\
Program               & 1  & --- & asympt.\ bezp. \\
\midrule
\textbf{\'Lacznie}   & \textbf{61} & & +12 sesja v41; \'Sc.~9, $n_s$, $r$, chiralnosc; +2 v46: $k{=}4$, \l{}a\'ncuch; +2 v47b: 0-param, $c$-cyklotom. \\
\midrule
...
\begin{enumerate}[nosep]
  ...
  \item \textbf{Kosmologia}: R\'ownanie Friedmanna jest
    ...
    (skrypt \texttt{ex204}, 5/7 PASS; 2 FAIL s\k{a} numeryczne).
