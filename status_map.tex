...
\begin{enumerate}[nosep]
  ...
  \item \textbf{Tabela zunifikowana (v47b):}
    ...
    \textbf{23 predykcje z~2 parametr\'ow} (w tym 2 nowe z~rury kolorowej),
    21/23 w~$1\sigma$, 22/23 w~$2\sigma$.
...
\begin{enumerate}[nosep]
  ...
  \item \textbf{Bilans predykcyjny --- mieszanie kalibracji z~predykcjami}:
    ...
    \textbf{12 predykcji zerowych [D]} (ratio~6:1),
    5~odzysk\'ow [R], 4~prospektywne [P].
    15/17 testowalnych w~$1\sigma$.
...
4-klasowa taksonomia pokazuje, \.ze \textbf{12 niezale\.znych
predykcji z~2 parametr\'ow} to ratio 6:1 --- nietrywialne
