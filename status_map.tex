...
Propozycja            & 26 & \'srednia & +6: antypod., $S_{\rm TGP}$, profile, chiralnosc, U(1), $k{=}4$ wymiar., \l{}a\'ncuch entrop.; +3 v47b: most substrat$\to g_0^e$, O-J1 WKB, \l{}a\'ncuch 0-param. \\
Hipoteza              & 5  & niska & $m_\tau$; T1+T2; $a_\Gamma\Phi_0{=}1$ (DESI DR2); CV${=}1$ \\
Szkic                 & 2  & --- & SU(2), SU(3) \\
Program               & 1  & --- & asympt.\ bezp. \\
\midrule
\textbf{\'Lacznie}   & \textbf{60} & & +12 sesja v41; \'Sc.~9, $n_s$, $r$, chiralnosc; +2 v46: $k{=}4$, \l{}a\'ncuch; +1 v47b: 0-param \\
\midrule
