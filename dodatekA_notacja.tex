...
$\kappa$ & $[-]$ & $\kappa = 3/(4\PhiZero)$ & --- & sek.~\ref{ssec:zunifikowana} \\
...
N0-5
  ...
  & $\beta = \gamma$;
    $V_{\mathrm{eff}}(g) = \frac{\gamma}{3}g^3 - \frac{\gamma}{4}g^4$,
    gdzie $g = \Phi/\PhiZero$
...
N0-7
  ...
  & $G(\Phi) = G_0\,\PhiZero/\Phi$ (A8);
    ...
    przy fizycznym $\kappa = 3/(2\Phi_0) = 0{,}061$:
    $\psi(0) = 0{,}836$,
    $|\dot{G}/G|/H_0 = 0{,}035$ --- czynnik $1{,}75\times$ powy\.zej LLR.
    Skan $\kappa$: $\kappa_{\rm krit} \approx 0{,}03$--$0{,}04$
    (tj.\ $\Phi_{0,\rm eff} \approx 37$--$50$) daje zgodno\'s\'c z~LLR.
    Ograniczenie LLR: $|\dot{G}/G| < 0{,}02\,H_0$
    (Williams et~al.\ 2004).
    \textbf{Status: ZAMKNI\k{E}TY z~napi\k{e}ciem} czynnika~$1{,}75$
    w~$|\dot{G}/G|$. Naprawa wymaga: precyzyjnego wyprowadzenia $\kappa$
    z~akcji TGP (mo\.zliwy dodatkowy czynnik $\sim 1/2$
    z~mapowania Jordan/Einstein) lub mechanizmu screeningu
