...
% ----------------------------------------------------------
\subsection{Chiralna symetria substratu}\label{ssec:chiralna}
...
\begin{proposition}[Symetria $\Zp$ z~mikrodynamiki]\label{prop:Z2}
Hamiltoniano substratu:
...
\end{equation}
jest niezmienniczy wzgl\k{e}dem \textbf{chiralnej inwersji}:
\begin{equation}\label{eq:Z2-chiral}
    \hat{s}_i \;\mapsto\; -\hat{s}_i
    \qquad \forall\, i \in V.
\end{equation}
Ta dyskretna symetria $\Zp$ jest fundamentaln\k{a}
symetri\k{a} substratu. Funkcja stanu $\Ffield$ mierzy
stopie\'n jej z\l{}amania.
\end{proposition}
...
\begin{axiom}[Niestabilno\'s\'c nico\'sci]\label{ax:P3}
...
- (\gamma/4)\Phi^4/\PhiZero^2$ w~otoczeniu $\Phi = 0$
