...
\begin{enumerate}[nosep]
  ...
  \item \textbf{Masa Higgsa}: $m_H = 125{,}1\;\mathrm{GeV}$ (pe\l{}ne 1-p\k{e}tlowe CW: top $+$ gauge,
    dod.~U \S T1a--T1c, U-OP4)
    --- z~1-p\k{e}tlowego potencja\l{}u CW, bez dostroje\.n. LO przybli\.zenie
    ($\sqrt{2\lambda v^2} = 123{,}7$ pomija wk\l{}ad p\k{e}tli gauge);
    D01-locked 2026-05-06.
\end{enumerate}
