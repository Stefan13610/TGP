...
%
% =====================================================================
% AUDIT 2026-05-01 (A1 + A2 + A3) — METRIC-FORM DRIFT NOTICE
% =====================================================================
...
\end{equation}
%
% --- STATUS (audit 2026-05-01, A1) -----------------------------------
% Forma (I) "boxed power" `g_tt = -c²/ψ` jest **FALSIFIED 2026-04-25**:
% M9.1 daje β_PPN=4, niezgodne z Mercury (3·10⁴σ). Aktualna kanoniczna
% metryka TGP = M9.1'' hiperboliczna `g_tt = -c²(4-3ψ)/ψ`. Pozostawione
% historycznie; **NIE u\.zywa\'c do nowych derivations**. Patrz nag\l{}\'owek
% audit-aware tego pliku.
% ---------------------------------------------------------------------
...
%
% --- STATUS (audit 2026-05-01, A1) -----------------------------------
% Forma (II) eksponencjalna `g_tt = -c²·e^{-2U}` jest **OBSOLETE /
% PRZEJ\'SCIOWA**: nie ma niezale\.znego wyprowadzenia z bud\.zetu, by\l{}a
% u\.zywana wy\l{}\k{a}cznie do uzyskania β_PPN=1 dok\l{}adnie. Aktualnie
% zast\k{a}piona przez M9.1'' hiperboliczn\k{a} (TGP_FOUNDATIONS.md:64-69).
% **NIE u\.zywa\'c do nowych derivations.**
% ---------------------------------------------------------------------
...
%
% --- STATUS (audit 2026-05-01, A1) -----------------------------------
% Forma (III) antypodyczna `f=ψ^(-1/2), h=ψ^(+1/2)` jest **NIESP\'OJNA
% WEWN\k{E}TRZNIE** (M9.1' §2.1, 2026-04-25): linearyzacja daje γ_PPN=1 ✓,
% ale pe\l{}ne O(ε²) daje β_metric=3 (NIE 1 jak deklaruje
% rem:antipodal-implications punkt 3). Z α=2 dynamic\k{a} (c_2=-1):
% β_PPN=7. Twierdzenie "jedyno\'sci" nie obejmuje pe\l{}nej nieliniowo\'sci.
% Aktualna kanoniczna metryka TGP = M9.1'' hiperboliczna.
% **NIE u\.zywa\'c do nowych derivations.**
% ---------------------------------------------------------------------
\end{theorem}
