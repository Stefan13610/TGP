...
The substrate Hamiltonian (v2, axiom pivot 2026-04-24; see
\texttt{tgp-core-paper/KNOWN\_ISSUES.md})
...
\end{equation}
is a Ginzburg--Landau gradient bond in the $\Zp$-even composite
$\hat{\Phi}_i \equiv \hat{s}_i^2$; it vanishes on any configuration with
$\hat{s}_i = 0$ (``no substrate $\Rightarrow$ no geometry''). It is
invariant under \textbf{chiral inversion}:
