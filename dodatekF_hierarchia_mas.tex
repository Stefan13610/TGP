...
a~formu\l{}a Koidego $Q = 2/3$ wynika automatycznie
($|Q - 2/3| = 6{,}2 \times 10^{-6}$).
...
\begin{equation}\label{eq:mass-K}
    m_n \propto K^*_n,
    \qquad
...
\begin{problem}[Formu\l{}a Koide z~TGP --- OTWARTY]\label{oprob:koide}
...
(\'scie\.zka~9, dodatek~\ref{app:J2-path9}) ujawnia
