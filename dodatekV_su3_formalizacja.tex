...
\begin{equation}\label{eq:V-alphas-formula}
  ...
  \;=\;
  \frac{7\,N_c^3\,g_0^e}{12\,\PhiZero},
  \qquad
  N_c = 3.
\end{equation}
gdzie $\Phi_{\rm eff} = \PhiZero \cdot P(1)/V(1) = \PhiZero \cdot 3/14 \approx 24{,}66$
(ekranowany dielektryk z~poprawionej akcji, \S\ref{ssec:unified-action}).%
...
\[
  \Phi_{\rm eff} = 115 \times 3/14 = 24{,}66,
  \quad
  \alpha_s^{(\mathrm{TGP})} = \frac{27 \times 0{,}8694}{8 \times 24{,}66}
  = 0{,}1190,
\]
...
\begin{equation}\label{eq:V-Phi0-VOP2}
  ...
  = 24{,}88,
\end{equation}
co jest sp\'ojne z~$\Phi_{\rm eff} = \PhiZero \cdot 3/14 = 24{,}66$
(odchylenie $0{,}9\%$)
...
V-OP2: $\alpha_s$ z~parametr\'ow substratu
  ...
  & Prop.~\ref{prop:V-alphas-substrate}:
    $\alpha_s = 7 N_c^3 g_0^e/(12\PhiZero)
    = N_c^3 g_0^e/(8\Phi_{\rm eff}) = 0{,}1190$
    ($1{,}2\sigma$ od PDG; ex219: 8/8~PASS).
    Re-derived z~poprawionej akcji zunifikowanej. \\[3pt]
