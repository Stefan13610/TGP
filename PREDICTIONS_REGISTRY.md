...
| **long-term** | full QG / UV experiment | UV1–UV7, F5, F6 (UV-route selection), **XI2** (UV-route map for N_A=8.7719: AS NGFP/LQG preferred), **UV4** (a₂ universality cross-sector), **UV5** (cascade DERIVED), **E7** (α-fine-structure prime-137 connection research-track) |
