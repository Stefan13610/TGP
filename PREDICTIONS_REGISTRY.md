...
| **H4** | **Cross-sector denom-prime sharing** (Wolfenstein A,ρ̄,η̄ ↔ K-taxonomy) — A=81=3⁴ shares prime-3 z K_lepton denom; η̄=14=2·7 shares prime-7 z K_up=7/8 numerator | structural hint, derivation OPEN; could promote z dedicated η.2 cycle (4-sector chirality-counting cross-product) | rigorous derivation excludes denom-3/7 sharing → cross-sector cascade hint broken | **STRUCTURAL** (cross-sector hint) | master-only (η.1.Phase3) | [`research/op-eta-wolfenstein/Phase3_results.md`](research/op-eta-wolfenstein/Phase3_results.md) (T3.4) |
...
| **A5** | **Residual 0.036 cascade research-track** — α⁻¹(0) − 137 = 0.0359990; best TGP rational fit 9/250 drift 0.0025% (soft denom 250 = 2·5³ no cross-sector link); STRUCTURAL HINT only | research-track open dla η.2 lub β.1 future cycle (rigorous derivation z F4 extension lub 4-sector chirality cross-product) | no rigorous derivation drift < 0.05% w future cycles → residual stays STRUCTURAL HINT permanently | **STRUCTURAL HINT** (research-track) | master-only (α.1.Phase3) | [`research/op-alpha-fine-structure/Phase3_results.md`](research/op-alpha-fine-structure/Phase3_results.md) (A3.5) |
| **A6** | **4-channel α.1 falsification convergence** (Atomic Cs/Rb α⁻¹(0) + LHC α⁻¹(M_Z) + ngEHT ψ_ph + research-track residual) | 3/4 LIVE + 1 research-track; threshold ≥3/4 met (margin +0); A5 may upgrade do 4/4 LIVE if rigorously derived | ≥2 z 4 channels reject framework → α.1 classification PARTIALLY DERIVED reverts STRUCTURAL HINT only | **LIVE** (2027–2030+) | master-only (α.1.Phase3) | [`research/op-alpha-fine-structure/Phase3_results.md`](research/op-alpha-fine-structure/Phase3_results.md) (A3.6) |
