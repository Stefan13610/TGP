...
| **XX3** | **BEST 2022 4σ Gallium → ⁷¹Ge cross-section TGP-native correction PROMOTED post-ρ.1** — σ_TGP/σ_Bahcall = (19/24)·(31/32)^{2/3} = 0.7751 sympy-LOCKED via K-level diff K_up−K_lep=5/24 + closure (Z_Ga/Z_Ge)^{2/3}; BEST 4σ tension reduced to 1.13σ residual (R_TGP=0.7751 vs BEST combined 0.8084±0.0295) | BEST 2022 4σ Gallium anomaly z STEREO 2023 95% CL exclusion → ρ.1 TGP-native chirality+closure correction matches BEST within 1.13σ + GALLEX/SAGE 1994-96 within 3σ all 4 historical measurements (2 within 1σ ★ GALLEX-Cr2 0.34σ, SAGE-Ar 0.15σ) | FRIB/iThemba 2027+ B(GT)_g.s. measured outside [0.060, 0.073] at σ ~1% → ρ.1 TGP form falsified; LANSCE/FRIB ⁷¹Ge(p,n)⁷¹Ga inverse-kinematics 2030+ universal 0.7751 factor breakdown → ρ.1 falsified | **PARTIALLY DERIVED** (post-ρ.1 ⁷¹Ge cross-section TGP-native) | master-only (ρ.1.Phase3) | [`research/op-rho1-71Ge-cross-section/Phase3_results.md`](research/op-rho1-71Ge-cross-section/Phase3_results.md) (R3.1) |
