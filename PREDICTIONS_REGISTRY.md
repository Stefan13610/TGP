...
| **~2035** | LISA / pulsar-timing arrays | GW4 (m_σ²/m_s² = 2 → 2.9% low-k phase shift), **BH5** (LISA SMBH ringdown 10⁶–10⁷ M_⊙), **XI3** (ξ-factor RG-invariance cross-scale), **UV3** (η_N*=-2 RG-running signature; ξ-factor invariance) |
...
| **long-term** | full QG / UV experiment | UV1–UV7, F5, F6 (UV-route selection), **XI2** (UV-route map for N_A=8.7719: AS NGFP/LQG preferred), **UV4** (a₂ universality cross-sector), **UV5** (cascade DERIVED) |
