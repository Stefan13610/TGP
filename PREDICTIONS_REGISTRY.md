...
| # | Anchor | Reference | Target / Horizon | Status | Flask | Master |
|---|---|---|---|---|---|---|
| **M911-P1** | **\|Δg_tt\|/c² = (5/6) U³ deviation od GR** (b_ppE = −1, 2PN-phase); β_ppE^TGP^(b=-1) = -(3/(128η))·(5/6)·G_SPA → **central -5/64 ≈ -7.81·10⁻²** (η=1/4, G_SPA=1); OOM window |β| ∈ [5.5·10⁻², 1.2·10⁻¹]. **WORKFLOW CAVEAT:** detection wymaga **dedicated TGP-specific Bayes prior** (single-coefficient β_TGP prior); generic LIGO ToGR multi-coefficient marginalized analysis (jak GWTC-2/3) jest factor ~50× weaker. Zob. [[research/op-GWTC3-reanalysis/Phase3_verdict.md]] §2. | g_tt^TGP/(-c²) = 1−2U+2U²−(7/3)U³+...; g_tt^GR/(-c²) = 1−2U+2U²−(3/2)U³+... (sympy LOCK 14/14: 7/7 α_n^TGP + 7/7 Δα_n; α=2 vacuum Φ-EOM + hyperbolic f(ψ); 0 free parameters); **GWTC-3 reanalysis 2026-05-07: TGP CONSISTENT within 1σ** (BF_TGP/GR ≈ 0.97 INCONCLUSIVE; 0.37σ deviation z observed centroid) | (z TGP-specific workflow A) LIGO-O5 single (2027+, A+ design SNR ~80): bound β_ppE^(b=−1) ~3·10⁻² → **TGP/bound ≈ 2.6 → first decisive single-event detection**; LIGO-O5 stack 100 BBH ~3·10⁻³ (>20σ); ET-D single (~2035) ~10⁻³ (>50σ); CE single ~3·10⁻⁴ (>200σ); ET+CE stack 5000 BBH ~10⁻⁴ (>700σ). (z generic ToGR workflow B) ~230,000 BBH events needed for 5σ, far beyond 3G era projected rates. | **LIVE** (2027+; threshold liczbowy LOCKED via `op-ppE-mapping` Phase 1; GWTC-3 reanalysis CONSISTENT 2026-05-07; G_SPA tighter 5%-lock pending Phase 1.5 future; **detection requires TGP-specific Bayes pipeline**) | tgp-core | [[research/op-newton-momentum/M9_1_pp_P1_results.md]] §3.2 + [[research/op-ppE-mapping/Phase1_results.md]] (sympy LOCK 14/14) + [[research/op-GWTC3-reanalysis/Phase3_verdict.md]] (CONSISTENT 2026-05-07) + [[audyt/T01_LIGO3G_falsifier/FALSIFIER_STATEMENT_DRAFT.md]] |
| **M911-P2** | **Multi-coefficient TGP-distinguishing signature** ratios {β_(N+1)PN_phase / β_NPN_phase} = **{−23/10, −38/23, +337/228}** (sympy-exact rationals; FORCED przez α=2 + hyperbolic f(ψ); 0 free parameters) | TGP β values (G_SPA=1): β_2PN = +5/64, β_3PN = -23/128, β_4PN = +19/64, β_5PN = -337/768 (sympy LOCK; from Δα_n = -5/6, +23/12, -19/6, +337/72); inne modyfikacje GR (dCS 1 free param, sGB 1, EÆ 4, BD 1) NIE reprodukują pattern z bare coefficients (wszystkie wymagają fitting) | ET-D + CE multi-coefficient ppE Bayes (3+ coefficients jednocześnie); ratio detection w 5%/5σ → TGP-specific identification; falsyfikacja jeśli ratio {β_3PN/β_2PN, β_4PN/β_3PN} odbiega od TGP predicted z 5σ | **DERIVED** (pattern sympy LOCK z α=2 + hyperbolic; observational falsifier pending `op-LIGO-3G-deviation` Phase 4 multi-coefficient Fisher) | tgp-core | [[research/op-ppE-mapping/Phase1_results.md]] §7 + [[research/op-ppE-mapping/Phase3_paper_ready.md]] §3 |
| **M911-P3** | **4-channel M9.1'' strong-field falsifier roadmap** (M911-P1 single-coefficient + M911-P2 multi-coefficient + BH5 QNM ringdown δf/f ~ 8–16% + ε.1/E6 photon-ring strong-field) | 4 niezależne kanały testujące M9.1'' deviation od GR w obszarze U ≳ 10⁻²; wzajemnie ortogonalne (waveform inspiral × ringdown × shadow geometry) | ≥2/4 channels confirm M9.1'' deviation w 5%/5σ → M9.1'' **DERIVED-OBSERVATIONAL**; <2/4 channels confirm → M9.1'' upada (powrót do S07 ścieżki C: status (P) ansatzu) | **LIVE** (2027–2035; konwergencja po LIGO-O5 stack 2027 + ET-D 2035 + ngEHT M87/SgrA 2030) | master-only (T01 audit) | [[audyt/T01_LIGO3G_falsifier/FINDINGS.md]] §1.6 + cross-link BH5, E6 |
...
| **2027+** | LIGO O5 | GW2 (3 DOF), GW5 (no vector), GW6 (dispersion bound), **BH5** (δf/f ~ 8–16% QNM ringdown), **M911-P1** (LIGO-O5 stack 100 BBH bound β_ppE^(b=−1) ~3·10⁻² → first decisive bound on (5/6) U³ deviation; TGP β_ppE^TGP ~10⁻¹ OOM borderline detection lub falsification) |
...
| **2035+** | Einstein Telescope (ET-D) + Cosmic Explorer (CE) BBH inspirale | **M911-P1** (single-event ET-D bound ~10⁻³, CE ~3·10⁻⁴ → decisive 5σ detection of (5/6) U³ deviation w fazie inspiralu; stack 5000 BBH ET+CE bound ~10⁻⁴ z >1000σ), **M911-P2** (multi-coefficient TGP-distinguishing pattern; ratio {β_3PN/β_2PN, β_4PN/β_3PN} reprodukowalne *tylko* z α=2 + hyperbolic f(ψ); odróżnia TGP od dCS, sGB, Einstein-Æther bez fitting) |
| **2027–2035** | 4-channel M9.1'' strong-field roadmap | **M911-P3** (M911-P1 LIGO-O5 stack + ET/CE; M911-P2 multi-coefficient ET+CE; BH5 QNM ringdown LIGO-O5/LISA; ε.1 / E6 photon-ring ngEHT 2030+; ≥2/4 channels confirm → M9.1'' DERIVED-OBSERVATIONAL; <2/4 → M9.1'' upada) |
