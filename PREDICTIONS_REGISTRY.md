...
| **2027+** | JUNO | **Z2** (sin²2θ₁₃ = 0.099 ± 0.5%; cross-sector λ_C/√2 lock), **Q4** (sin θ_C/sin θ₁₃ = √2 EXACT; ratio drift current 7.5%), **II1** (sin²θ₁₃_ι.1 = K_ν·λ_C² = 0.025425 ultra-sharp window [0.024, 0.027] post-ι.1 PMNS DERIVED via mixing-operator (ν,up) pair + Cabibbo lock) |
...
| **2030+** | DUNE / T2HK | **Z3** (θ₂₃ octant resolution > 5σ; TGP maximal sin²θ₂₃ = 1/2 vs NuFit 2nd octant 0.572), **II2** (sin²θ₂₃_ι.1 = K_ν = 1/2 hardened window [0.48, 0.52] post-ι.1 Majorana-Dirac chirality lock via (lep,ν) pair + Z₂ atmospheric reflection) |
