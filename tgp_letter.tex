...
\item \textbf{Cabibbo angle}: the tree-level $4.8\sigma$ tension
  is resolved by replacing $N = 3$ with the effective generation count
  $N_\mathrm{eff} = 3.043$, giving $\lambda_C = \OL/N_\mathrm{eff}
  = 0.22501$ ($< 0.1\sigma$).
  This value coincides with the SM neutrino decoupling $N_\mathrm{eff}
  = 3.044$, hinting at a Cabibbo--neutrino connection.
