...
# -*- coding: ascii -*-
"""
op-3d-canonical-lattice (Phase 3) -- RACHUNEK CENTRALNY: spektrum
Blocha wokol samouzgodnionych tel sieci sc 3D (sektor tachionowy, akcja
kanoniczna K=g^4, U=g^7/7-g^8/8, beta=gamma=1).

KOPIA ../op-3d-lattice-bath-stability-2026-08-31/Phase3_bloch3d.py
(nieuruchomionego; zawiera juz korekte eigsh tol=0 + kontrole pokrycia
translacji z Phase_correction_note_eigsh.md poprzednika).
DELTY (Phase_method_decisions.md sec. 4, FROZEN): sciezki BASE/NPZ/OUT
na katalog tego cyklu; naglowek (INPUT g0_mu = phi*0.90548 = 1.4650974).

LOCK: Phase0_balance.md sec. 3 Phase 3 (przejete doslownie od poprzednika).
...
INPUT: g0_mu=1.4650974 (=phi*0.90548), d*1=3.0790, beta=gamma=1,
eps (nieuzywane w spektrach -- bez regularyzacji, LOCK sec. 2).
"""
import json
import time
import numpy as np
...
print("(model kanoniczny). LOCK sec. 3 Phase 3; FROZEN: MD-poprzednika")
print("sec. 1/2/6 (przejete); korekta 1 (eigsh tol=0):")
print("../op-3d-lattice-bath-stability-2026-08-31/Phase_correction_note_"
      "eigsh.md.")
print("INPUT: g0_mu=1.4650974 (=phi*0.90548), d*1=%.4f, beta=gamma=1."
      % DSTAR1)
print("=" * 78)
