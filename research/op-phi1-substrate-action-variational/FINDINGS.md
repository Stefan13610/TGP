---
title: "FINDINGS — op-phi1-substrate-action-variational"
date: 2026-05-03
parent: "[[README.md]]"
type: findings
...
# FINDINGS — op-phi1-substrate-action-variational
...
|------|-------|--------|---------|-------|---------|
| `Phase1_results.md` | `φ.1.Phase1` | `PASS` | — | — | — |
| `Phase2_results.md` | `φ.1.Phase2` | `PASS` | — | — | — |
| `Phase3_results.md` | `φ.1.Phase3` | `PASS` | — | — | — |
