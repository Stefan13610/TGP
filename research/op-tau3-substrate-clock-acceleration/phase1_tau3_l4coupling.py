...
def t13_effective_mass_derivation():
    banner("T1.3 -- Effective mass m_e_eff(X) derivation [AUDIT 2026-05-01 A5 PATCH]")
    print("  Starting point: L4_a Lagrangian density [multiplicative dim-6 EFT, A5-corrected]")
    print("    L_psi = i psi-bar gamma^mu D_mu psi - m_e[1 + (alpha_g/Lambda^2)(d ln X)^2] psi-bar psi")
    print()
    print("  Define effective mass [multiplicative — A5 patch]:")
    print("    m_e_eff(X) = m_e^(0) * [1 + (alpha_g/Lambda^2) (d_mu ln X)(d^mu ln X)]")
    print()
    print("  In a region with substrate gradient |d ln X| ~ Delta:")
    print("    delta m_e / m_e^(0) = (alpha_g/Lambda^2) * Delta^2  [dimensionless, A5-coherent]")
    print()
    ...
    print()
    print("  Differentiate [A5-corrected]:")
    print("    delta omega / omega = delta m_e / m_e^(0) = (alpha_g/Lambda^2) Delta^2")
    print("    (PRE-AUDIT WITHDRAWN: (alpha_g/(Lambda^2 m_e^(0))) Delta^2 — dim-incoherent)")
    print()
