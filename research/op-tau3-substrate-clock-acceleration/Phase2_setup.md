...
- **T2.1** sympy LOCK δω/ω formula [⚠ A5-patched 2026-05-01 — multiplicative]:
  m_e_eff = m_e^(0)·[1 + (α_g/Λ²)(∂ ln X)²], E_n ∝ m_e c² α_em²,
  so δω/ω = δm_e/m_e^(0) = (α_g/Λ²)(∂ ln X)² **bez 1/m_e** factor (dim-coherent).
  Original additive form `m_e + (α_g/Λ²)(∂lnX)²` WITHDRAWN — dimensionally niespójne.
