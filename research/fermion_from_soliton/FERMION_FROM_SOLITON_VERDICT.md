...
**Nuclear "Pauli-gap" z [[../nuclear_from_soliton/NUCLEAR_FROM_SOLITON_VERDICT.md]] NIE JEST spatial antysymetryzacją — jest SPIN-IZOSPIN channel gap.**
...
- [[../nuclear_from_soliton/NUCLEAR_FROM_SOLITON_VERDICT.md]] — źródło Pauli-gap
- [[../nuclear_from_soliton/nfs05_variational_convergence.py]] — convergence test
- [[../atom_from_soliton/ATOM_FROM_SOLITON_VERDICT.md]] — inny typ Pauli-gap
- [[../qm_statistics/q6_statistics.py]] — exchange statistics postulate
- [[../../nbody/pairwise.py]] — scalar V_NN (gdzie TGP nie ma channel struktury)
