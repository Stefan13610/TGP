...
\medskip\noindent
\textbf{Status}: Zamkni\k{e}te: A1 (NUM, 6/6~PASS), A3 (algebraiczny),
A4 (strukturalny + ERG, 6/7~PASS).
Pozosta\l{}e: \textbf{A2} (lokalno\'s\'c, szkic --- standardowy argument
homogenizacyjny) i~\textbf{A5} (z\l{}o\.zenie A1--A4 w~twierdzenie).
...
Stan zamkni\k{e}cia:
(1)~dolny szacunek gradientowy \textbf{A1 --- zamkni\k{e}ty} (ERG + MC, 6/6~PASS),
(2)~t\l{}umienie nielokalnych ogon\'ow (A2 --- szkic),
(3)~algebraiczne $\alpha = 2$ (A3 --- propozycja, algebraicznie zamkni\k{e}ty),
(4)~identyfikacja wsp\'o\l{}czynnik\'ow \textbf{A4 --- zamkni\k{e}ty}
    (arg.~strukt.\ + ERG, 6/7~PASS),
(5)~z\l{}o\.zenie w~s\l{}abe twierdzenie continuum (A5 --- szkic).
