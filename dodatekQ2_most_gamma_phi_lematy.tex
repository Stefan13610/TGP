...
\medskip\noindent
\textbf{Priorytet}: Lemat~A1 (kompaktowo\'s\'c) zosta\l{} \textbf{zamkni\k{e}ty
numerycznie} (ERG~CG-2 + MC~N3 + formalny most, 6/6~PASS).
Lemat~A3 jest algebraicznie zamkni\k{e}ty
(por.~prop.~\ref{prop:Q-alpha-from-phi-squared}).
Nast\k{e}pny priorytet: \textbf{Lemat~A2} (lokalno\'s\'c) lub
\textbf{Lemat~A4} (identyfikacja wsp\'o\l{}czynnik\'ow, etap~N2).
...
(4)~identyfikacja potencja\l{}u (A4 --- program, wymaga N2),
