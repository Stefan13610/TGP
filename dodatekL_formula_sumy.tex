...
O-L4 & \textbf{Mechanizm cz\k{e}\'sciowo wyja\'sniony} (\texttt{ex92}, v37).
     ...
     & $\alpha_{\min}= 2{,}544 \approx 28/11$ (\texttt{ex219}, 12/12~PASS);
       $F_{\min} = 196{,}4$ (gap $5\%$ do $R_{21}$);
       analityczne $dF/d\alpha=0$ otwarte \\[4pt]
O-L5 & \textbf{$\alpha^*_3$ --- definitywnie brak rozwi\k{a}zania}
     ...
     & \statuslabel{CZ. ZAMK. [NUM] (negatywnie)}
     & $\alpha^*_3$ nie istnieje; $G_3>R_{31}$ wszędzie; v38--v39 \\
\bottomrule
\end{tabular}
\end{center}
