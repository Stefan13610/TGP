...
kinetic coupling $\alpha = 2$ is proved as an algebraic theorem from
the substrate Hamiltonian; functional RG confirms its stability under
Wilsonian flow. We evaluate 15~kill criteria (all survived), compare
