...
Sekcja ta uzupe\l{}nia analiz\k{e} kwantyzacji z~dod.~\ref{app:E}
...
(tw.~\ref{thm:D-uniqueness}, dod.~\ref{app:B}).
...
Substrat TGP (dod.~\ref{app:B}, tw.~\ref{thm:D-uniqueness})
...
Mosty B1~(\S\ref{app:R-A4-zero-mode}) i~B2~(\S\ref{app:R2-qk-z3})
