...
\begin{proposition}[Zero-parametrowa predykcja mas leptonowych]
\label{prop:Z-zero-param-chain}
\L{}a\'ncuch ERG nie zawiera parametr\'ow wolnych dla stosunk\'ow mas:
\[
  \rho_0^* = 0{,}03045 \;\xrightarrow{c=13/3}\;
  g_0^e = 0{,}868
  \;\xrightarrow{\varphi\text{-FP}}\;
  g_0^\mu = 1{,}405
  \;\xrightarrow{\text{Koide}}\;
  g_0^\tau = 1{,}570
  \;\xrightarrow{\text{ODE}\times 3}\;
  r_{21},\; r_{31},\; m_\tau.
\]
Parametr $\Phi_0$ odpada: determinuje $a_\Gamma = 1/\Phi_0$ (T1),
ale $a_\Gamma$ nie wchodzi do ODE solitonu.
Wyniki (skrypt \texttt{tgp\_chain\_Phi0\_to\_masses.py}, 9/9~PASS):
\begin{center}
\begin{tabular}{lrrr}
\toprule
Obs. & \l{}a\'ncuch ERG & PDG & odch. \\
\midrule
$r_{21}$ & $210{,}67$ & $206{,}77$ & $1{,}9\%$ \\
$r_{31}$ & $3537{,}4$ & $3477{,}2$ & $1{,}7\%$ \\
$m_\tau$ & $1807{,}6$\,MeV & $1776{,}9$\,MeV & $1{,}7\%$ \\
\bottomrule
\end{tabular}
\end{center}
Jedynym wej\'sciem spoza TGP jest $\rho_0^*$ (punkt sta\l{}y Wilsona--Fishera
w~$d=3$ z~CG-2).
$N_{\rm free}^{\rm (masy)} = 0$.
\end{proposition}

\begin{proposition}[Struktura sta\l{}ej ERG: $c(\alpha)$ i~wybr\'or $\alpha{=}2$]
\label{prop:Z-c-alpha-structure}
Sta\l{}a $c = (1{-}g_0^e)/\rho_0^*$ \textbf{zale\.zy} od parametru koordynatowego~$\alpha$.
Przybli\.zone warto\'sci $c(\alpha)$ przy $d=3$:
\begin{center}\footnotesize
\begin{tabular}{ccccc}
\toprule
$\alpha$ & $0{,}5$ & $1$ & $2$ & $3$ \\
\midrule
$c$ & $3{,}39$ & $3{,}68$ & $4{,}34$ & $5{,}14$ \\
\bottomrule
\end{tabular}
\end{center}
Przy \textbf{kanonicznym} $\alpha = 2$ ($\Phi = \phi^2$)
numeryka daje $c = 4{,}345$, co odpowiada
\begin{equation}\label{eq:c-cyclotomic}
  c(\alpha{=}2,\, d) = \frac{d^2 + d + 1}{d}
    = \frac{\Phi_3(d)}{d},
\end{equation}
gdzie $\Phi_3$ jest trzecim wielomianem cyklotomicznym.
Przy $d = 3$: $c = 13/3$ (odch.\ $0{,}27\%$ od numeryki).
$\alpha$ spe\l{}niaj\k{a}cy $c = 13/3$ dok\l{}adnie:
$\alpha^* \approx 1{,}984 \approx 2$ (0{,}8\%).
\textbf{To singluje $\alpha = 2$ jako fizycznie preferowany
wyb\'or koordynat} --- jedyny, przy kt\'orym
$c$ jest racjonaln\k{a} cyklotomiczn\k{a} sta\l{}\k{a}.

Dodatkowa obserwacja: przy $\alpha = 0$ (brak cz\l{}onu krzy\.zowego)
$c(0) \approx \pi$ (0{,}30\%), \textbf{specyficznie w~$d = 3$}
($d=2$: odch.~22\%, $d=4$: odch.~17\%).

Mapa translacji $c(\alpha)$ jest dobrze przybli\.zona kwadratow\k{a}:
\begin{equation}\label{eq:c-alpha-quadratic}
  c(\alpha) \approx \pi + 0{,}469\,\alpha + 0{,}066\,\alpha^2
  \qquad (\text{RMS} = 0{,}005,\;\; d=3),
\end{equation}
daj\k{a}c $c(0) = \pi$, $c(2) = 4{,}344$ ($0{,}25\%$ od $13/3$).
Model wyk\l{}adniczy $c(\alpha) = \pi \exp(\lambda\alpha)$
z~$\lambda = \ln(13/(3\pi))/2 = 0{,}1608$ daje
maksymalny b\l{}\k{a}d $1{,}3\%$ (do $\alpha = 3{,}5$).

Wniosek: $c(0) = \pi$ (dok\l{}adno\'s\'c WF)
i~$c(2) = 13/3$ (cyklotomiczny) to dwa numeryczne
\textbf{boundary conditions} mapy $c(\alpha)$,
kt\'ore razem singluj\k{a} $\alpha = 2$ i~$d = 3$.

Skrypty \texttt{tgp\_c133\_origin.py} (4/4~PASS),
\texttt{tgp\_c\_alpha\_translation.py} (4/4~PASS).
\end{proposition}

\begin{remark}[Levinson i~pochodzenie $c(0) = \pi$]
\label{rem:Z-levinson}
Analiza fazowa solitonu (\texttt{tgp\_c0\_pi\_derivation.py}, 1/1~PASS)
wyja\'snia $c(\alpha{=}0) \approx \pi$ \textbf{strukturalnie}:
\begin{enumerate}[nosep]
  \item Przy $g_0 \to 1^-$ (elektron): faza ogona
    $\delta(g_0) \to \pi$ (zmierzono $\delta(0{,}995) = 0{,}9975\,\pi$).
  \item Przy $g_0 \to 1^+$ (mion): $\delta \to 0$.
  \item Skok fazowy $\Delta\delta = \pi$ przy przej\'sciu
    przez vacuum $g{=}1$ --- analogia z~\textbf{twierdzeniem Levinsona}:
    soliton ma dok\l{}adnie 1~stan zwi\k{a}zany.
  \item Re\.zim liniowy: $A_{\rm tail} \approx \varepsilon = |g_0{-}1|$
    (stosunek $A/\varepsilon \to 1$ przy $\varepsilon \to 0$);
    korekta nieliniowa: $K_\mu/K_e = 0{,}78$ (znacz\k{a}ca asymetria).
  \item Nachylenie: $c'(0) \approx 3/(2\pi)$ (1{,}8\%),
    $c''(0)/2 \approx 1/15$ (0{,}75\%).
\end{enumerate}
Wniosek: $c(0) = \pi$ wynika z~geometrii sferycznej ($d = 3$)
i~topologii solitonu (1~stan zwi\k{a}zany~$\Rightarrow$ skok $\pi$),
\textbf{nie} z~numerologii.
\end{remark}

\begin{remark}[Rekomendacja programowa -- aktualizacja]
Po zamkni\k{e}ciu OP-3, mostu substratowego, pe\l{}nego \l{}a\'ncucha numerycznego,
identyfikacji $c = \Phi_3(d)/d$ i~powi\k{a}zania $c(0){=}\pi$
z~twierdzeniem Levinsona,
najwa\.zniejsze otwarte problemy to:
\begin{enumerate}[nosep]
  \item \textbf{formalny dow\'od} $c(0) = \pi$
    z~twierdzenia Levinsona dla ODE solitonu ---
    prawdopodobnie perturbacyjna ekspansja solitonu
    blisko $g{=}1$ w~po\l{}\k{a}czeniu ze struktur\k{a}
    punktu sta\l{}ego Wilsona--Fishera;
