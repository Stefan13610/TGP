...
(w~ramach OP-3).
\textbf{Precyzacja statusu.}
Po sesjach v45--v47b problem OP-3 rozdzielamy na:
\begin{enumerate}[nosep,label=(\alph*)]
  \item \textbf{OP-3A}: bezpo\'srednie wyprowadzenie
    $\alpha_K^{\rm old}$ z~Warstwy~I--II bez u\.zycia $r_{21}$;
  \item \textbf{OP-3B}: jawna mapa
    $\alpha_K^{\rm old}\leftrightarrow(g_0^*,g_0^e,\varphi\text{-FP})$,
    kt\'ora degraduje dawn\k{a} \'scie\.zk\k{e} S2 do statusu legacy.
\end{enumerate}
W~niniejszym dodatku zamykamy tylko cz\k{e}\'s\'c OP-3B:
supersesj\k{e} starej \'scie\.zki S2 oraz zast\k{a}pienie jej
przez kandydat S2c oparty na~$g_0^*$.
\end{remark}
