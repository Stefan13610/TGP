...
maszyneria wielociałowa (V₂ z [[pairwise.py]] + V₃ z [[three_body_force_exact.py]])
...
**[[FERMION_FROM_SOLITON_VERDICT.md]] (27/27 PASS: fs01 6/6 + fs02 13/13 + fs03 8/8)**
...
- [[ATOM_FROM_SOLITON_VERDICT.md]] — wodór PASS
- [[COHESION_VERDICT.md]] — materia-skala luka
- [[pairwise.py]] — implementacja V₂
- [[three_body_force_exact.py]] — implementacja V₃
- [[sek10_N0_wyprowadzenie.tex]] — m_sp w TGP
- [[dodatekF_hierarchia_mas.tex]] — leptony (WKB nodes, ale bez explicit spin)
- [[dodatekE_kwantyzacja.tex]] — Dirac struktura (pojedynczy cząstka)
- [[dodatekU_su2_formalizacja.tex]] — SU(2) emergence (chiral asymmetry, ghost barrier)
- [[dodatekF_hierarchia_mas.tex]] lub equiv — leptony z WKB
