...
- [[tgp_bound_state.tex]]: trzy-ciałowe stany związane z V₂+V₃
- [[tgp_efimov_analog.tex]]: analog Efimova
...
- [[ATOM_FROM_SOLITON_VERDICT.md]] — łańcuch atom
- [[tgp_bound_state.tex]] — teoria 3-body w TGP
- [[pairwise.py]] — implementacja V₂
- [[three_body_force_exact.py]] — implementacja V₃ (Feynman exact)
- [[sek10_N0_wyprowadzenie.tex]] — m_sp definicja
