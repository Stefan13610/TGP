...
\[
  ...
  \underbrace{r^2 = 2 = N{-}1}_{\eqref{eq:T-r-from-QK}}.
\]
...
\end{enumerate}
Status O-L5: pochodzenie $Q_K = 3/2$ jest \textbf{zamkni\k{e}te}
--- wynika z~\l{}\k{a}cucha $d{=}3 \to 2$~sk\l{}adowe ogona
$\to$ $\chi^2(2)$ $\to$ $\mathrm{CV}{=}1$
(rem.~\ref{rem:T-cv1-origin},
...
\medskip\noindent
\textbf{Konkluzja O-L5 (zaktualizowana, v47b):}
$Q_K = 3/2$ jest \textbf{konsekwencj\k{a} strukturaln\k{a}}
w\l{}asno\'sci ODE w~$d = 3$ i~$N_{\rm gen} = 3$
(patrz \l{}\k{a}cuch dedukcyjny w~rem.~\ref{rem:T-cv1-origin}
i~prop.~\ref{prop:T-pythagorean-selection}).
Dwa wej\'scia wyznaczaj\k{a} pe\l{}ne widmo mas lepton\'ow:
\[
  ...
  (m_e,\; m_\mu,\; m_\tau).
\]
\L{}\k{a}cuch: oscylacyjny ogon w~$d = 3$ daje 2~sk\l{}adowe
$(a,b)$; suma pitagorejska $A^2 = a^2 + b^2$ nadaje inwariancj\k{e}
obrotow\k{a}; $\chi^2(2)$ z~dw\'och sk\l{}adow\'ow
= $N{-}1 = 2$ mod\'ow $\Rightarrow$ $\mathrm{CV}(A^2) = 1$
$\Rightarrow$ $Q_K = 3/2$.
...
Wyprowadzenie strukturalne pochodzi z~innej \'scie\.zki:
$d = 3 \to 2$~sk\l{}adowe ogona $\to$ $\chi^2(2)$ $\to$
$\mathrm{CV} = 1$ $\to$ $Q_K = 3/2$
(rem.~\ref{rem:T-cv1-origin},
prop.~\ref{prop:T-pythagorean-selection}).
...
\medskip\noindent
\textbf{Konkluzja (zaktualizowana):}
Ramy $\chi^2(2)$ wyja\'sniaj\k{a}, \emph{dlaczego}
Koide dzia\l{}a na poziomie masy
(inwariancja $A^2 = a^2 + b^2$).
Dalsze \'scie\.zki (22--23) wykaza\l{}y zbie\.zno\'s\'c
$\chi^2(2)$ z~argumentem Brannena (rem.~\ref{rem:T-cv1-origin}),
zamykaj\k{a}c \l{}\k{a}cuch dedukcyjny:
$d = 3 \to 2$~sk\l{}adowe $= N{-}1$~mod\'ow $\to$
$\mathrm{CV}(A^2) = 1$ $\to$ $Q_K = 3/2$.
...
(rem.~\ref{rem:T-equipartition-motivation}),
...
Po 23 \'scie\.zkach analizy, $Q_K = 3/2$ jest
\textbf{konsekwencj\k{a} strukturaln\k{a}} TGP,
nie parametrem wej\'sciowym.
\L{}\k{a}cuch dedukcyjny:
\begin{enumerate}[nosep]
  \item $d = 3$ $\Rightarrow$ oscylacyjny ogon z~dwiema
    sk\l{}adowymi $(a, b)$
    \hfill(prop.~\ref{prop:T-oscillatory-tail})
  \item $A^2 = a^2 + b^2$ $\Rightarrow$ inwariancja pitagorejska
    \hfill(prop.~\ref{prop:T-pythagorean-selection})
  \item $N_{\mathrm{gen}} = 3$ $\Rightarrow$ $N{-}1 = 2$
    niezale\.zne mody = 2~sk\l{}adowe ogona
    \hfill(rem.~\ref{rem:T-cv1-origin})
  \item $\chi^2(2) \Rightarrow \mathrm{CV}(A^2) = 1
    \Leftrightarrow Q_K = 3/2$
    \hfill(tw.~\ref{thm:T-QK-CV})
\end{enumerate}
Za\l{}o\.zenie po\'srednicz\k{a}ce --- hipoteza ekwipartycji
(tw.~\ref{thm:T-QK-from-Ngen}): $N{-}1$ mod\'ow
wnosi jednakowy wk\l{}ad do wariancji.
Jest fizycznie motywowana i~strukturalnie potwierdzona
przez zbie\.zno\'s\'c $\chi^2(2)$--Brannen.
